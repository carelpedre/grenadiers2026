...
const dict = {
  ...
  "home.hero.body": {
    en: "For the first time since 1974, Haiti returns to the FIFA World Cup. Brazil. Scotland. Morocco. One group, one nation, one story — told here.",
    fr: "Pour la première fois depuis 1974, Haïti revient à la Coupe du Monde FIFA. Brésil. Écosse. Maroc. Un groupe, une nation, une histoire — racontée ici.",
    ht: "Pou premye fwa depi 1974, Ayiti tounen nan FIFA World Cup. Brezil. Eskòs. Mawòk. Yon gwoup, yon nasyon, yon istwa — n ap rakonte isit la.",
  },
  "home.hero.fixtures": {
    en: "Fixtures",
    fr: "Calendrier",
  ...
  "home.subtitle": {
    en: "After 52 years, Les Grenadiers return to the World Cup. The story, the squad, the watch parties, the music — all in one place.",
    fr: "Après 52 ans, les Grenadiers reviennent à la Coupe du Monde. L'histoire, l'effectif, les soirées de visionnage, la musique — tout au même endroit.",
    ht: "Apre 52 ane, Grenadye yo tounen nan Coupe du Monde. Istwa a, ekip la, watch party yo, mizik la — tout nan yon sèl kote.",
  },
