...
const dict = {
  ...
  "matches.statusFinished": { en: "Finished", fr: "Terminé", ht: "Terminé" },
  "matches.statusLive": { en: "Live", fr: "En direct", ht: "En direct" },
  "matches.statusHalftime": { en: "Half-time", fr: "Mi-temps", ht: "Mi-temps" },
  "matches.statusExtraTime": { en: "Extra time", fr: "Prolongation", ht: "Prolongation" },
  "matches.statusBreak": { en: "Break", fr: "Pause", ht: "Pause" },
  "matches.statusPenalties": { en: "Penalty shootout", fr: "Tirs au but", ht: "Tirs au but" },
  "matches.statusSuspended": { en: "Suspended", fr: "Suspendu", ht: "Suspendu" },
  "matches.statusInterrupted": { en: "Interrupted", fr: "Interrompu", ht: "Interrompu" },
  "matches.statusPostponed": { en: "Postponed", fr: "Reporté", ht: "Reporté" },
  "matches.statusCancelled": { en: "Canceled", fr: "Annulé", ht: "Annulé" },
  "matches.statusAbandoned": { en: "Abandoned", fr: "Abandonné", ht: "Abandonné" },
  "matches.statusAwarded": { en: "Awarded", fr: "Sur tapis vert", ht: "Sur tapis vert" },
  // Calendar reminder button
  "matches.calReminder": { en: "📅 Add to calendar", fr: "📅 Rappel agenda", ht: "📅 Rappel agenda" },
  "matches.calAdded": { en: "✓ Added to calendar", fr: "✓ Ajouté à l'agenda", ht: "✓ Ajouté à l'agenda" },
  // Stadium weather
  "matches.weatherInCity": { en: "in {city}", fr: "à {city}", ht: "à {city}" },
  "matches.weatherLoading": { en: "Loading weather…", fr: "Chargement de la météo…", ht: "Chargement de la météo…" },
  ...
  "matches.standingsEmptyBody": {
    ...
    ht: "Le classement du Groupe C s'affichera ici. Il s'actualise automatiquement pendant le tournoi.",
  },
  "matches.standingsFootnote": {
    ...
    ht: "Les deux premières équipes accèdent aux 16es de finale, avec les huit meilleures troisièmes des douze groupes. Classement actualisé automatiquement.",
  },
  "matches.std.team": { en: "Team", fr: "Équipe", ht: "Équipe" },
  "matches.std.played": { en: "P", fr: "J", ht: "J" },
  "matches.std.playedFull": { en: "Played", fr: "Joués", ht: "Joués" },
  "matches.std.won": { en: "W", fr: "G", ht: "G" },
  "matches.std.wonFull": { en: "Won", fr: "Gagnés", ht: "Gagnés" },
  "matches.std.drawn": { en: "D", fr: "N", ht: "N" },
  "matches.std.drawnFull": { en: "Drawn", fr: "Nuls", ht: "Nuls" },
  "matches.std.lost": { en: "L", fr: "P", ht: "P" },
  "matches.std.lostFull": { en: "Lost", fr: "Perdus", ht: "Perdus" },
  "matches.std.gf": { en: "GF", fr: "BP", ht: "BP" },
  "matches.std.gfFull": { en: "Goals for", fr: "Buts pour", ht: "Buts pour" },
  "matches.std.ga": { en: "GA", fr: "BC", ht: "BC" },
  "matches.std.gaFull": { en: "Goals against", fr: "Buts contre", ht: "Buts contre" },
  "matches.std.gd": { en: "GD", fr: "Diff", ht: "Diff" },
  "matches.std.gdFull": { en: "Goal difference", fr: "Différence", ht: "Différence" },
  "matches.std.pts": { en: "Pts", fr: "Pts", ht: "Pts" },
  // Recent form section
  "matches.recentForm": { en: "Recent form", fr: "Forme récente", ht: "Forme récente" },
  "matches.recentFormSub": {
    en: "The Grenadiers' latest matches.",
    fr: "Les derniers matchs des Grenadiers.",
    ht: "Les derniers matchs des Grenadiers.",
  },
  "matches.last5": { en: "Last 5", fr: "5 derniers", ht: "5 derniers" },
  "matches.venueHome": { en: "Home", fr: "Dom.", ht: "Dom." },
  "matches.venueAway": { en: "Away", fr: "Ext.", ht: "Ext." },
  "matches.compWcQual": { en: "WC Qualifiers", fr: "Éliminatoires CDM", ht: "Éliminatoires CDM" },
  "matches.compNationsLeague": { en: "Nations League", fr: "Ligue des Nations", ht: "Ligue des Nations" },
  "matches.compGoldCup": { en: "Gold Cup", fr: "Gold Cup", ht: "Gold Cup" },
  "matches.compFriendly": { en: "Friendly", fr: "Amical", ht: "Amical" },
  "matches.compWorldCup": { en: "World Cup", fr: "Coupe du Monde", ht: "Coupe du Monde" },

  // ─── LIVE MATCH CENTER (/live/:slug) ──────────────────────────────────
  "live.backToMatches": { en: "← All matches", fr: "← Tous les matchs", ht: "← Tous les matchs" },
  "live.kickoffIn": { en: "Kickoff in", fr: "Coup d'envoi dans", ht: "Coup d'envoi dans" },
  "live.accessLabel": { en: "Access:", fr: "Accès :", ht: "Accès :" },
  "live.broadcastLabel": { en: "Broadcast:", fr: "Diffusion :", ht: "Diffusion :" },
  "live.readRecap": { en: "Read the match recap →", fr: "Lire le résumé du match →", ht: "Lire le résumé du match →" },
  "live.seats": { en: "seats", fr: "places", ht: "places" },
  "live.statusFullTime": { en: "Full time", fr: "Fin de match", ht: "Fin de match" },
  "live.tabTimeline": { en: "Timeline", fr: "Chronologie", ht: "Chronologie" },
  "live.tabLineups": { en: "Lineups", fr: "Compositions", ht: "Compositions" },
  "live.tabStats": { en: "Stats", fr: "Statistiques", ht: "Statistiques" },
  "live.tabPlayers": { en: "Players", fr: "Joueurs", ht: "Joueurs" },
  "live.preMatch": { en: "Before the match", fr: "Avant le match", ht: "Avant le match" },
  "live.liveUpdates": { en: "Live updates", fr: "Mises à jour en direct", ht: "Mises à jour en direct" },
  "live.endedMsg": {
    en: "Match over. The final score is shown above.",
    fr: "Match terminé. Le score final est affiché ci-dessus.",
    ht: "Match terminé. Le score final est affiché ci-dessus.",
  },
  "live.startedMsg": {
    ...
    ht: "Le match a commencé. Le score est mis à jour automatiquement ci-dessus.",
  },
  "live.otherMatches": { en: "Other matches", fr: "Autres matchs", ht: "Autres matchs" },
  "live.evGoalUpper": { en: "GOAL", fr: "BUT", ht: "BUT" },
  "live.evGoal": { en: "Goal", fr: "But", ht: "But" },
  "live.evYellow": { en: "Yellow card", fr: "Carton jaune", ht: "Carton jaune" },
  "live.evRed": { en: "Red card", fr: "Carton rouge", ht: "Carton rouge" },
  "live.evSub": { en: "Substitution", fr: "Changement", ht: "Changement" },
  "live.subInOut": { en: "{on} on, {off} off", fr: "entrée de {on}, sortie de {off}", ht: "entrée de {on}, sortie de {off}" },
  "live.assistLabel": { en: "assist:", fr: "passe :", ht: "passe :" },
  "live.tagPen": { en: "(pen.)", fr: "(pén.)", ht: "(pén.)" },
  "live.tagOwnGoal": { en: "(o.g.)", fr: "(csc)", ht: "(csc)" },
  "live.subsTitle": { en: "Substitutes", fr: "Remplaçants", ht: "Remplaçants" },
  "live.benchTitle": { en: "Bench", fr: "Banc", ht: "Banc" },
  "live.coachLabel": { en: "Coach:", fr: "Sélectionneur :", ht: "Sélectionneur :" },
  "live.statsKey": { en: "Key stats", fr: "Statistiques clés", ht: "Statistiques clés" },
  "live.statsAll": { en: "All stats", fr: "Toutes les statistiques", ht: "Toutes les statistiques" },
  "live.colPlayer": { en: "Player", fr: "Joueur", ht: "Joueur" },
  "live.colRating": { en: "Rating", fr: "Note", ht: "Note" },
  "live.colMin": { en: "Min", fr: "Min", ht: "Min" },
  "live.colMinFull": { en: "Minutes", fr: "Minutes", ht: "Minutes" },
  "live.colGoals": { en: "G", fr: "B", ht: "B" },
  "live.colGoalsFull": { en: "Goals", fr: "Buts", ht: "Buts" },
  "live.colAssists": { en: "A", fr: "PD", ht: "PD" },
  "live.colAssistsFull": { en: "Assists", fr: "Passes décisives", ht: "Passes décisives" },
  "live.colShots": { en: "S", fr: "T", ht: "T" },
  "live.colShotsFull": { en: "Shots", fr: "Tirs", ht: "Tirs" },
  "live.colShotsOn": { en: "SOT", fr: "TC", ht: "TC" },
  "live.colShotsOnFull": { en: "Shots on target", fr: "Tirs cadrés", ht: "Tirs cadrés" },
  "live.cdDays": { en: "days", fr: "jours", ht: "jours" },
  ...
  "live.scoutingSub": {
    ...
    ht: "Avant le coup d'envoi : la forme du moment et le bilan face à Haïti.",
  },
  "live.scoutingForm": { en: "Recent form", fr: "Forme récente", ht: "Forme récente" },
  "live.scoutingVsHaiti": { en: "Against Haiti", fr: "Face à Haïti", ht: "Face à Haïti" },
  "live.scoutingFirstMeeting": {
    en: "First ever meeting between the two nations.",
    fr: "Première confrontation entre les deux nations.",
    ht: "Première confrontation entre les deux nations.",
  },
  "live.theOpponent": { en: "the opponent", fr: "l'adversaire", ht: "l'adversaire" },
  "live.scoutingTitle": { en: "Opponent scouting", fr: "Scouting adversaire", ht: "Scouting adversaire" },
  "live.scoutingFormOf": { en: "Recent form: {name}", fr: "Forme récente de {name}", ht: "Forme récente de {name}" },
  "live.scoutingFormUnavail": { en: "Recent form unavailable.", fr: "Forme récente indisponible.", ht: "Forme récente indisponible." },
  "live.meetingSingular": { en: "meeting", fr: "rencontre", ht: "rencontre" },
  "live.meetingsPlural": { en: "meetings", fr: "rencontres", ht: "rencontres" },
  "live.goalsWord": { en: "goals", fr: "buts", ht: "buts" },
  "matches.details": {
    en: "Details",
    fr: "Détails",
    ht: "Détails",
